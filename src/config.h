...
#define AP_PASSWORD    "12345678"   // must be 8-63 chars (WPA2 minimum) — replace with your fixed provisioning password
#define AP_PORTAL_PORT 80

// Shared-secret query-param gate for the admin dashboard (/admin?key=...).
// NOT real authentication — see the caveat in dashboard.h. Change this
// before handing a device to anyone outside the immediate dev team.
#define ADMIN_PORTAL_KEY "admin123"
